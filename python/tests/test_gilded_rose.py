...
class GildedRoseTest(unittest.TestCase):
    ...
    """aumento da qualidade do aged brie depois do sell_in"""
    def test_aged_brie_quality_increases_after_sellin(self):
    ...
    """qualidade do sulfuras é sempre 80 por muito tempo"""
    def test_sulfuras_quality_all_time(self):
        items = [Item("Sulfuras, Hand of Ragnaros", 10, 80)]
        gilded_rose = GildedRose(items)
        for _ in range(100):
            gilded_rose.update_quality()
    ...
    """aumento da qualidade do backstage pass com aumento do sell_in antes de 10"""
    def test_backstage_pass_quality_increases_by_1(self):
    ...
    """qualidade de backstage passes nunca maiores que 50 """

    def test_backstage_pass_quality_never_greater_than_50_at_12_days(self):
        items = [Item("Backstage passes to a TAFKAL80ETC concert", 12, 49)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_quality()
        self.assertEqual(50, items[0].quality)

    def test_backstage_pass_quality_never_greater_than_50_at_10_days(self):
        items = [Item("Backstage passes to a TAFKAL80ETC concert", 10, 49)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_quality()
        self.assertEqual(50, items[0].quality)

    def test_backstage_pass_quality_never_greater_than_50_at_5_days(self):
